...
export const ArrowUp = () => {
  ...
  return <div onClick={clickHandler} className={cn('flex fixed bottom-[8%] right-[4%] w-10 h-10 rounded-full transition-opacity bg-orange cursor-pointer', hidden ? 'opacity-0 pointer-events-none -z-50' : 'opacity-100 z-50')}>
    <svg
      className='m-auto'
